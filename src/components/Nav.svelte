		...
		<li>
			<a href="/">
			  <span style="color: orangered; font-weight:bold;">The</span> 
				  <svg version="1.1" id="Layer_1" width="25px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 102.72" 
					  style="enable-background:new 0 0 122.88 102.72; color: orangered; font-weight:bold;" xml:space="preserve">
